from meta_binding import BaseBinding, UnexpectedBindingType
import pytest
...
def test_unbind():
    ...
    assert obj3.bindings[obj4.bindname] is None
    assert obj3.bindings[obj5.bindname] is None
    assert obj3.bindings[obj6.bindname] == obj6
    assert obj4.bindings[obj3.bindname] is None
    assert obj5.bindings[obj3.bindname] is None
    assert obj6.bindings[obj3.bindname] == obj3
